...
import com.daysofree.freeweather.gson.Forecast;
import com.daysofree.freeweather.gson.Images;
import com.daysofree.freeweather.gson.Weather;
import com.daysofree.freeweather.util.HttpUtil;
import com.daysofree.freeweather.util.Utility;
    ...
    private void loadBingPic() {
        ...
        HttpUtil.sendOkHttpRequest(Url, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                final String url = "http://s.cn.bing.net" + images.getUrl();
                try {
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
